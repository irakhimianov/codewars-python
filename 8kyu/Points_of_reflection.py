...
relative to a mid-point, Q has a corresponding point, P1, which is the same distance from Q but in the opposite direction.
...
def symmetric_point(p, q):
    # your code here
    return [-p[i] + 2 * q[i] for i in range(0, 2)]